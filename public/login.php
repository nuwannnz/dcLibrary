...
<div class="content center-align-bl" style="min-height:770px;background-color:#fff;padding-top:50px;" >
    ...
    <h1 class="center-align-in" style="margin-top:0px;padding-top:30px;" >Sign in to your online account</h1>
...
?>
    ...
    <form action="<?php echo $header_paths['submit_forms'] . '/login_submit.php'; ?>" method="POST" class="input-form" onsubmit="return validateLoginForm();"  >
        ...
        <p class="font-small">No Account? <a href="register.php">Create one</a></p>
    </form>
